...
export default function SimpleMenu({type}) {
  ...
  const handleSelect= (sel) => {
    ...
    setAppState(prevState =>({
      ...
      filter:['filteredType', sel.currentTarget.dataset.myValue],
  ...
  return (
      ...
      aria-controls="simple-menu"
       aria-haspopup="true"
        ...
        {appState.filter[0] == 'filteredType'?appState.filter[1]:'Type'}
      </Button>
      <Menu
        id="simple-menu"
        anchorEl={anchorEl}
